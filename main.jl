...
function stationary_process_tracking()
    log_info("<> Running stationary process prediction example...\n$(SEPERATOR)")
    sample_time = 0.5
...
function transform_integrated_OU()
    log_info("<> Calculating conjugate models for integrated OU models...\n$(SEPERATOR)")
    sample_time = 1.0
...
function transform_singer()
    log_info("<> Calculating conjugate models for Singer models...\n$(SEPERATOR)")
    sample_time = 1.0
    alpha_range = -10:0.001:0
